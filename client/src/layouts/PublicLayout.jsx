      ...
      <div className="bg-brand-black text-xs text-gray-300 py-2 border-b border-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 flex flex-wrap items-center justify-between gap-2">
          <div className="flex items-center gap-4">
            <span className="flex items-center gap-1"><Phone className="w-3.5 h-3.5 text-brand-lime" /> +91 98765 43210</span>
            <span className="hidden sm:inline text-gray-500">|</span>
            <span className="hidden sm:inline">Admissions Open for NEET 2026 Batch Alpha</span>
          </div>
          <div className="flex items-center gap-4">
            <TelegramLink username="neetvidya_official" label="Telegram Channel" className="text-xs text-sky-400 hover:text-sky-300" />
            <WhatsAppLink number="919876543210" label="Admissions Desk" className="text-xs text-emerald-400 hover:text-emerald-300" />
          </div>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="flex items-center justify-between h-20">
            <Link to="/" className="flex items-center gap-2">
              <div className="w-10 h-10 rounded-xl bg-gradient-to-tr from-brand-green to-brand-lime flex items-center justify-center font-heading font-extrabold text-brand-black text-xl shadow-md">
                NV
              </div>
              <div>
                ...
                <span className="text-[10px] tracking-widest uppercase text-gray-400 font-semibold block mt-0.5">Medical Institute</span>
              </div>
            </Link>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
            <div className="md:col-span-2">
              <div className="flex items-center gap-2 mb-4">
                <div className="w-9 h-9 rounded-lg bg-gradient-to-tr from-brand-green to-brand-lime flex items-center justify-center font-heading font-extrabold text-brand-black text-lg">
                  NV
                </div>
                <span className="font-heading font-extrabold text-2xl text-white">NEET<span className="text-brand-lime">VIDYA</span></span>
              </div>
              ...
              <div className="flex items-center gap-4">
                <TelegramLink username="neetvidya_official" label="Telegram Channel" className="text-xs text-sky-400" />
                <WhatsAppLink number="919876543210" label="Admissions Helpline" className="text-xs text-emerald-400" />
              </div>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="text-sm mb-2 text-gray-300">NEETVIDYA Academic Campus</p>
              <p className="text-sm mb-2 text-gray-400">Sector V, Salt Lake, Kolkata, West Bengal</p>
              <p className="text-sm mb-2 text-gray-400">Helpline: +91 98765 43210</p>
              <p className="text-sm text-gray-400">Email: admissions@neetvidya.com</p>
            </div>
          </div>
