    ...
    <div className="section-padding bg-brand-soft min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="text-center max-w-2xl mx-auto mb-16">
          <span className="text-xs font-bold text-brand-green uppercase tracking-widest">Medical Preparation Programs</span>
          <h1 className="font-heading font-extrabold text-3xl sm:text-5xl text-brand-dark mt-2">Courses Tailored for NEET Rankers</h1>
          <p className="text-gray-600 text-sm sm:text-base mt-3">
            Choose your target program with complete syllabus coverage, curated DPPs, and comprehensive test series.
          </p>
        </div>
            ...
            {courses.map((course) => (
              <div key={course._id} className="card card-hover flex flex-col justify-between border-gray-200">
                ...
                <div className="pt-5 border-t border-gray-100 flex items-center justify-between">
                  <div>
                    <span className="text-xs text-gray-500 block">Total Tuition</span>
                    <span className="font-extrabold text-xl text-brand-dark">₹{course.feeAmount?.toLocaleString() || "45,000"}</span>
                  </div>
